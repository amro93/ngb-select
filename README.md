...
### 6. Searchable Multi-Select with Checkboxes & Chips

Enable multiple selection with live search filtering, "Select All" header, custom search placeholder, and removable chip badges:
